...
'components' => [
    'view' => [
        'theme' => [
            'pathMap' => [
                '@zoocreative/user/views' => '@app/views/user'
            ],
        ],
    ],
],
...
In the above `pathMap` means that every view in @zoocreative/user/views will be first searched under `@app/views/user` and
